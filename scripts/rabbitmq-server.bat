...
echo RABBITMQ SERVER ARGS
echo "!ERLANG_HOME!\bin\erl.exe" -pa "!RABBITMQ_EBIN_ROOT!" -boot start_sasl !RABBITMQ_START_RABBIT! !RABBITMQ_CONFIG_ARG! !RABBITMQ_GENERATED_CONFIG_ARG! !RABBITMQ_NAME_TYPE! !RABBITMQ_NODENAME! +W w +A "!RABBITMQ_IO_THREAD_POOL_SIZE!" !RABBITMQ_DEFAULT_ALLOC_ARGS! !RABBITMQ_SERVER_ERL_ARGS! !RABBITMQ_LISTEN_ARG! -kernel inet_default_connect_options "[{nodelay, true}]" !RABBITMQ_SERVER_ADDITIONAL_ERL_ARGS! -sasl errlog_type error -sasl sasl_error_logger !SASL_ERROR_LOGGER! -rabbit lager_log_root "!RABBITMQ_LOG_BASE:\=/!" -rabbit lager_default_file !RABBIT_LAGER_HANDLER! -rabbit lager_upgrade_file !RABBITMQ_LAGER_HANDLER_UPGRADE! -rabbit feature_flags_file "!RABBITMQ_FEATURE_FLAGS_FILE:\=/!" -rabbit enabled_plugins_file "!RABBITMQ_ENABLED_PLUGINS_FILE:\=/!" -rabbit plugins_dir "!RABBITMQ_PLUGINS_DIR:\=/!" -rabbit plugins_expand_dir "!RABBITMQ_PLUGINS_EXPAND_DIR:\=/!" -os_mon start_cpu_sup false -os_mon start_disksup false -os_mon start_memsup false -mnesia dir "!RABBITMQ_MNESIA_DIR:\=/!" -ra data_dir "!RABBITMQ_QUORUM_DIR:\=/!" !RABBITMQ_SERVER_START_ARGS! !RABBITMQ_DIST_ARG! !STAR!
